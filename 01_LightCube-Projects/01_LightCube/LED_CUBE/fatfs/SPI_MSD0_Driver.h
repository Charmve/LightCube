...
#define SD_DMA           							 DMA2
#define SD_DMA_RCC        						 RCC_AHB1Periph_DMA2

#define SD_DMA_RX_CHANNEL 						 DMA_Channel_3
#define SD_DMA_RX_STREAM  						 DMA2_Stream0
#define SD_DMA_RX_TCIF    						 DMA_FLAG_TCIF0

#define SD_DMA_TX_CHANNEL 						 DMA_Channel_3
#define SD_DMA_TX_STREAM  						 DMA2_Stream5
#define SD_DMA_TX_TCIF                 DMA_FLAG_TCIF5
